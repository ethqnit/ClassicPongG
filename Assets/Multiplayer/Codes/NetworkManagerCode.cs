...
public class NetworkManagerCode : MonoBehaviourPunCallbacks
{
    public Text status;
    public AudioSource audioSource;
    public AudioSource audioSource2;
    public AudioSource audioSource3;
    public ChartBAds Ads;
    ...
    public void Update()
    {
        ...
        if (roomExists)
        {
            if (PhotonNetwork.CurrentRoom.PlayerCount == 2 && entrou == false )
            {
              ...
              if (PhotonNetwork.CurrentRoom.PlayerCount == 1 && entrou == true)
              {
                    roomExists = false;
    ...
    public override void OnJoinedRoom()
    {
        ...
        if (PhotonNetwork.CurrentRoom.PlayerCount == 1)
        {
            ...
            string key = "Player1";
            string value = GameJoltAPI.Instance.CurrentUser.Name; // Player is an imaginary script.
            bool isGlobal = true;
        ...
        {
             PhotonNetwork.Instantiate(player2.name, pos, rot, group);
